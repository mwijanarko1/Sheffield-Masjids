#!/usr/bin/env node
/**
 * Fetches Al-Rahman Mosque Sheffield prayer data from mosqueprayertimes.org:
 * adhan (`prayers-ajax-list`) and iqamah (`mosques-ajax-list`).
 *
...
const BASE = "https://alrahman.mosqueprayertimes.org";
const MOSQUE_ID = "50";
const SLUG = "al-rahman-mosque";
