...
export default async function Home() {
  ...
  return (
    <main className="relative min-h-[100svh] w-full">
      ...
      />
      <section className="relative z-10 mx-auto max-w-4xl px-5 pb-32 pt-16 text-white sm:px-8">
        <div className="rounded-2xl border border-white/10 bg-[#0A1128]/75 p-6 shadow-2xl backdrop-blur-xl sm:p-10">
          <h2 className="text-2xl font-black tracking-tight sm:text-3xl">Sheffield mosque prayer times</h2>
          <div className="mt-5 space-y-4 leading-7 text-white/80">
            ...
            <section className="space-y-3 pt-4">
              <h3 className="text-xl font-bold text-white">Adhan and iqamah are different times</h3>
              <p>
            ...
            <section className="space-y-3">
              <h3 className="text-xl font-bold text-white">Choosing the correct mosque</h3>
              <p>
            ...
            <section className="space-y-3">
              <h3 className="text-xl font-bold text-white">Dates, timezone, and clock changes</h3>
              <p>
            ...
            <section className="space-y-3">
              <h3 className="text-xl font-bold text-white">Monthly and daily timetables</h3>
              <p>
            ...
            <section className="space-y-3">
              <h3 className="text-xl font-bold text-white">Ramadan schedules</h3>
              <p>
            ...
            <section className="space-y-3">
              <h3 className="text-xl font-bold text-white">Jumu&apos;ah and special announcements</h3>
              <p>
            ...
            <section className="space-y-3">
              <h3 className="text-xl font-bold text-white">Calendar exports and reminders</h3>
              <p>
            ...
            <section className="space-y-3">
              <h3 className="text-xl font-bold text-white">Sources, corrections, and responsibility</h3>
              <p>
            ...
            <section className="space-y-3">
              <h3 className="text-xl font-bold text-white">Finding a time quickly</h3>
              <p>
            ...
            <section className="space-y-3">
              <h3 className="text-xl font-bold text-white">What this directory does not decide</h3>
              <p>
            ...
            <section className="space-y-3">
              <h3 className="text-xl font-bold text-white">Missing and unusual timetable values</h3>
              <p>
          ...
          <nav aria-label="Information" className="mt-7 flex flex-wrap gap-4 text-sm font-bold">
            <Link href="/timetable" className="text-[#FFB380] underline underline-offset-4">Browse timetables</Link>
            <Link href="/compare" className="text-[#FFB380] underline underline-offset-4">Compare mosques</Link>
            <Link href="/about" className="text-[#FFB380] underline underline-offset-4">About Sheffield Masjids</Link>
            <Link href="/contact" className="text-[#FFB380] underline underline-offset-4">Contact</Link>
            <Link href="/privacy" className="text-[#FFB380] underline underline-offset-4">Privacy</Link>
          </nav>
        </div>
      </section>
    </main>
