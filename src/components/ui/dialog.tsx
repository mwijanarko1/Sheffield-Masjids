...
>(({ className, children, showCloseButton = true, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 w-[calc(100vw-1.5rem)] max-w-xl -translate-x-1/2 -translate-y-1/2 gap-4 rounded-[2rem] border border-white/10 bg-[#091227]/96 p-6 text-white shadow-lg backdrop-blur-xl",
        className,
      )}
      {...props}
    >
